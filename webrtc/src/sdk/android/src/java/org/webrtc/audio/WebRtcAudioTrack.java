...
import org.webrtc.audio.JavaAudioDeviceModule.AudioTrackProcessingCallback;
...
class WebRtcAudioTrack {
  ...
  private final @Nullable AudioTrackProcessingCallback processCallback;
  ...
  private class AudioTrackThread extends Thread {
    ...
    public void run() {
      ...
      while (keepAlive) {
  	  ...
  	  processCallback.onWebRtcAudioTrackProcess(byteBuffer);
        }
  ...
  WebRtcAudioTrack(Context context, AudioManager audioManager) {
    this(context, audioManager, null /* errorCallback */, null /* stateCallback */, null /* processCallback */);
  }

  WebRtcAudioTrack(Context context, AudioManager audioManager,
      @Nullable AudioTrackErrorCallback errorCallback,
      @Nullable AudioTrackStateCallback stateCallback, 
      @Nullable AudioTrackProcessingCallback processCallback) {
