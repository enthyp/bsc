...
public class JavaAudioDeviceModule implements AudioDeviceModule {
  ...
  public static class Builder {
    ...
    private AudioTrackProcessingCallback audioTrackProcessingCallback;
    ...
    /**
     * Set a callback to process an audio frame inside the AudioTrack.
     */
    public Builder setAudioTrackProcessingCallback(AudioTrackProcessingCallback audioTrackProcessingCallback) {
      this.audioTrackProcessingCallback = audioTrackProcessingCallback;
      return this;
    }
    ...
    public AudioDeviceModule createAudioDeviceModule() {
      ...
      final WebRtcAudioTrack audioOutput = new WebRtcAudioTrack(
          context, audioManager, audioTrackErrorCallback, audioTrackStateCallback, audioTrackProcessingCallback);
  ...
  /** Called on each frame of audio data. */
  public static interface AudioTrackProcessingCallback {
    void onWebRtcAudioTrackProcess(ByteBuffer byteBuffer);
  }
